...
def calculate_costs(modules_included):
...
def analyze_costs():
    ...
    remaining_cubes, savings = calculate_costs(modules_included)
    ...
    modules_to_buy, free_modules = calculate_remaining_modules(remaining_modules, remaining_cubes)
...
def calculate_remaining_modules(remaining_modules, remaining_cubes):
